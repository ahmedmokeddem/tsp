...
def RED_DEERS(
    ...
    for inter in range(nb_iteration):
        ...
        for i in range(Nb_males):
            population[i] = list(HillClimbing(graph, nbIterationsHCRoaring,
...
if __name__ == "__main__":
    ...
    print(RED_DEERS(graph, 15, 0.5, 0.5, 0.5, 0.3, 10, PPV, 100, 100, SEL_TOURNAMENT))